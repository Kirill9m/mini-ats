Core features:
    ...
    Som admin kan jag skapa konton (både admin-konton & kund-konton)
    ...
    Som kund kan jag filtrera kanban-vyn på jobb & kandidatnamn
...
Leverans:
    ...
    Spela in en 5min demo video mha Loom eller liknande verktyg och dela med mig
